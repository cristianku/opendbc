...
class CarControllerParams:
  ...
  STEER_MAX = 20  # Maximum steering torque command that can be applied (unitless scaling factor)
  ...
  STEER_DRIVER_ALLOWANCE = 5  # Deadband (in Nm) where driver input does not affect steering assist (prevents interference)
